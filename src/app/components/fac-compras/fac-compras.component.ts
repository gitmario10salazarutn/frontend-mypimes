...
export class FacComprasComponent implements OnInit {
  ...
  makePDF(numerof:any){
    ...
    autoTable(pdf, {
      startY : 50,
      tableLineWidth: 2,
      columnStyles: { 0: { halign: 'center', fillColor: [255, 218, 185] },
    ...
    */
    ...
    console.log(this.buscar_nombre_pro(1))
    console.log(this.buscar_nombre_pro(2))
...
public buscar_nombre_pro(id: number){
  let nombre : String = "";
  this.productos.forEach( producto => {
    if (id == producto.pro_id) {
